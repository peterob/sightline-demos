    ...
    <div className="max-w-xl mx-auto fade-in">
      <div className="card overflow-hidden">
        ...
        <div className="h-1 bg-stone-100">
          <div 
            className="h-full bg-gradient-to-r from-stone-600 to-stone-800 transition-all duration-500" 
        ...
        <div className="p-8">
          ...
          {step === 0 && (
            <div className="text-center slide-up">
              ...
              <p className="text-stone-500 mb-8">Financial transparency for your club. Let's get set up in about 5 minutes.</p>
              
              <div className="text-left space-y-3 mb-8">
                {[
                  'Connect your bank accounts securely',
                  'Import your budget and historical data',
                  'Invite your finance committee',
              ...
              <button 
                onClick={() => setStep(1)} 
                className="w-full py-4 btn-primary rounded-xl font-medium text-lg shadow-lg hover:shadow-xl transition-all"
              >
                Get Started
              </button>
            </div>
            ...
            <div className="slide-up">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input 
                    type="text" 
                    defaultValue="Palm Harbor Country Club" 
                    className="w-full px-4 py-3 border border-stone-200 rounded-xl focus:ring-2 focus:ring-stone-400 focus:border-transparent focus:outline-none transition-all" 
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-stone-700 mb-2">Club Type</label>
                  <select className="w-full px-4 py-3 border border-stone-200 rounded-xl bg-white focus:ring-2 focus:ring-stone-400 focus:outline-none">
              ...
              <div className="flex gap-3 mt-8">
                ...
                <button 
                  onClick={() => setStep(2)} 
                  className="flex-1 py-3 btn-primary rounded-xl font-medium"
                >
                  Continue
                </button>
              </div>
              ...
              <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 bg-white rounded-xl flex items-center justify-center border border-stone-200 shadow-sm">
                        <span className="font-bold text-blue-700 text-lg">T</span>
                      </div>
                      <div>
                ...
                <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-xl mt-4">
                  ...
                  <div className="text-sm text-blue-800">
                    <span className="font-medium">Bank-level security.</span> We use Plaid to connect your accounts. Your credentials are never stored on our servers.
                  </div>
                </div>
              </div>

              <div className="flex gap-3 mt-8">
                <button onClick={() => setStep(1)} className="px-6 py-3 text-stone-600 font-medium hover:bg-stone-50 rounded-xl">Back</button>
                <button onClick={() => setStep(3)} className="flex-1 py-3 btn-primary rounded-xl font-medium">Continue</button>
              </div>
            </div>
          )}
          ...
          {step === 3 && (
            <div className="slide-up">
              ...
              <div className="flex gap-3 mt-8">
                <button onClick={() => setStep(2)} className="px-6 py-3 text-stone-600 font-medium hover:bg-stone-50 rounded-xl">Back</button>
                <button onClick={() => setStep(4)} className="px-4 py-3 text-stone-600 font-medium hover:bg-stone-50 rounded-xl">Skip</button>
                <button onClick={() => setStep(4)} className="flex-1 py-3 btn-primary rounded-xl font-medium">Continue</button>
              </div>
            </div>
          )}
          ...
          {step === 4 && (
            <div className="slide-up">
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-3 bg-stone-50 rounded-xl">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-sm font-medium text-stone-800">{person.name}</div>
              ...
              <div className="flex gap-3 mt-8">
                <button onClick={() => setStep(3)} className="px-6 py-3 text-stone-600 font-medium hover:bg-stone-50 rounded-xl">Back</button>
                <button 
                  onClick={onComplete} 
                  className="flex-1 py-3 bg-emerald-600 text-white rounded-xl font-medium hover:bg-emerald-700 transition-colors shadow-lg"
                >
                  Launch Dashboard →
                </button>
              </div>
